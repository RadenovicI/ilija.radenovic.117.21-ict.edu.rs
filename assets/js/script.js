...
function ispisRadnoVreme(nizObjekata){
    ...
    for(let objekat of nizObjekata){
        ispis +=`<p class="mb-1 font-weight-bold">${objekat.dani}<span
                class="font-weight-normal pl-2 text-muted">${objekat.pocetakRadnogVremena} - ${objekat.krajRadnogVremena}</span></p>`
    }
                ...
                <div class="custom-list">
                    ...
                    <div class="info">
                        ...
                        for(let obj of objekat.velicina){
                            ...
                            ispis+=`<p class="float-right text-primary">${obj.cm} cm - ${obj.cena.uobicajenaCena}</p>
                            </div>
                            <div class="body">`
                    }
...
function sortJelovnik(nizElemenata){
    ...
    if(tipSortiranja=="0"){
        ...
        sortiraniElementi = nizElemenata.sort(function(a,b){
            ...
            if(tipSortiranja=="3"){
                if(nizElemenata.kategorija == "Pice"){
                    if(a.velicina.cena < b.velicina.cena){
                        return 1;
                    }
                    else if(a.velicina.cena > b.velicina.cena){
                        return -1
                    }
                    else return 0
                }
